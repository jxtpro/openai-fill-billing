...
# **depay停用后，新的充值方式上线，文档整理需要时间，请先star(很重要)然后直接扫描二维码获取新的充值方式：**
加V可手把手教学。绑定不成功直接加我，
...
1.下载 depay 钱包 app,下载地址： **https://dupay.one/web-app/register-h5?invitCode=oQvZD4&lang=zh-cn** ，建议使用手机打开页面，并使用安卓版本，为什么？ **因为方便啊，我用的安卓下载的。**
